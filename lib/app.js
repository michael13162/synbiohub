...
var views = {
    ...
    profile: require('./views/profile'),
    groups: require('./views/groups'),
    createGroup: require('./views/createGroup'),
    removeGroup: require('./views/removeGroup'),
    addGroupUser: require('./views/addGroupUser'),
    removeGroupUser: require('./views/removeGroupUser'),
    admin: {
...
function App() {
    ...
    // Groups
    app.get('/groups', requireUser, views.groups);
    app.all('/groups/create', requireUser, views.createGroup);
    app.post('/groups/delete', requireUser, views.removeGroup);
    app.post('/groups/addUser', requireUser, views.addGroupUser);
    app.post('/groups/removeUser', requireUser, views.removeGroupUser);
