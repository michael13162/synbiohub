...
let query = isSearch?loadTemplate('./sparql/CountMembersSearch.sparql', templateParams):loadTemplate('./sparql/CountMembers.sparql', templateParams);
console.log(query);
...
let query = loadTemplate('./sparql/RootCollectionMetadata.sparql', {});
...
let query = isSearch?loadTemplate('sparql/getCollectionMembersSearch.sparql', templateParams):
...
let query = loadTemplate('./sparql/SubCollectionMetadata.sparql', {
...
return sparql.queryJson(query, graphUri).then((sparqlResults) => {
let results = sparqlResults.map(function(result) {
return {
uri: result['Collection'],
name: result['name'] || '',
description: result['description'] || '',
...
let query = loadTemplate('sparql/getCollectionMetaData.sparql', templateParams);
